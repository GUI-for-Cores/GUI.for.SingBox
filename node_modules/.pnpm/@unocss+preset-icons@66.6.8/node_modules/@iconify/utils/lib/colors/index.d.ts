 ...
 * Color to hex
 */
declare function colorToHexString(color: RGBColor, canCompact?: boolean, canRound?: boolean): string | null;
/**
 * Convert color to string
 */
declare function colorToString(color: Color, canRound?: boolean): string;
