...
const DefaultRulesetIds = {
  ...
  GEOIP_RU_BLOCKED: 'GeoIP-RU-Blocked',
  GEOSITE_RU_BLOCKED: 'GeoSite-RU-Blocked',
...
export const DefaultRoute = (): IRoute => ({
  rules: [
    ...
    },
    {
      id: sampleID(),
      type: RuleType.RuleSet,
      payload: DefaultRulesetIds.GEOSITE_RU,
      invert: false,
      action: RuleAction.Route,
      outbound: DefaultOutboundIds.Direct,
      sniffer: [],
    ...
    },
    {
      id: sampleID(),
      type: RuleType.RuleSet,
      payload: DefaultRulesetIds.GEOIP_RU,
      invert: false,
      action: RuleAction.Route,
      outbound: DefaultOutboundIds.Direct,
      sniffer: [],
    ...
    },
    {
      id: sampleID(),
      type: RuleType.RuleSet,
      payload: DefaultRulesetIds.GEOSITE_RU_BLOCKED,
      invert: false,
      action: RuleAction.Route,
      outbound: DefaultOutboundIds.Select,
      sniffer: [],
    ...
    },
    {
      id: sampleID(),
      type: RuleType.RuleSet,
      payload: DefaultRulesetIds.GEOIP_RU_BLOCKED,
      invert: false,
      action: RuleAction.Route,
      outbound: DefaultOutboundIds.Select,
      sniffer: [],
  ...
  rule_set: [
    ...
    {
      id: DefaultRulesetIds.GEOSITE_RU,
      type: RulesetType.Remote,
      tag: DefaultRulesetIds.GEOSITE_RU,
      format: RulesetFormat.Binary,
      url: 'https://testingcf.jsdelivr.net/gh/runetfreedom/russia-v2ray-rules-dat@release/sing-box/rule-set-geosite/geosite-category-ru.srs',
      download_detour: DefaultOutboundIds.Direct,
      update_interval: '',
      rules: '',
      path: '',
    ...
    {
      id: DefaultRulesetIds.GEOIP_RU,
      type: RulesetType.Remote,
      tag: DefaultRulesetIds.GEOIP_RU,
      format: RulesetFormat.Binary,
      url: 'https://testingcf.jsdelivr.net/gh/runetfreedom/russia-v2ray-rules-dat@release/sing-box/rule-set-geoip/geoip-ru.srs',
      download_detour: DefaultOutboundIds.Direct,
      update_interval: '',
      rules: '',
      path: '',
    ...
    {
      id: DefaultRulesetIds.GEOIP_RU_BLOCKED,
      type: RulesetType.Remote,
      tag: DefaultRulesetIds.GEOIP_RU_BLOCKED,
      format: RulesetFormat.Binary,
    ...
    {
      id: DefaultRulesetIds.GEOSITE_RU_BLOCKED,
      type: RulesetType.Remote,
      tag: DefaultRulesetIds.GEOSITE_RU_BLOCKED,
      format: RulesetFormat.Binary,
      url: 'https://testingcf.jsdelivr.net/gh/runetfreedom/russia-v2ray-rules-dat@release/sing-box/rule-set-geosite/geosite-ru-blocked-all.srs',
      download_detour: DefaultOutboundIds.Direct,
      update_interval: '',
      rules: '',
      path: '',
